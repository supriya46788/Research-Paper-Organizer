                ...
                <div class="paper-card ${selectedPaper?.id === paper.id ? 'selected' : ''}" onclick="selectPaper(${paper.id})">
                    <div class="paper-header">
                        ...
                        <div class="paper-actions">
                            ${paper.url ? `<button class="paper-action-btn" onclick="event.stopPropagation(); openPaperLink('${paper.url}')" title="Open paper link">
                                <i class="fas fa-external-link-alt"></i>
                            </button>` : ''}
                            <button class="paper-action-btn" onclick="event.stopPropagation(); editPaper(${paper.id})" title="Edit paper">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="paper-action-btn delete" onclick="event.stopPropagation(); deletePaper(${paper.id})" title="Delete paper">
                    ...
                    <div class="paper-meta">
                        ...
                        ${paper.year ? `<span class="year-badge"><i class="fas fa-calendar"></i> ${paper.year}</span>` : ''}
            ...
            detailsContent.innerHTML = `
                ...
                <div class="detail-section">
                    ...
                    <div class="tags-container">
                        ${selectedPaper.tags.map(tag => `<span class="detail-tag">#${tag}</span>`).join('')}
                    </div>
                </div>
                ` : ''}
                    ...
                    <div>
                        ...
                        <div class="citation-item">
                            <div class="citation-header">
                                ...
                                <button class="copy-btn" onclick="copyToClipboard('${generateCitation(selectedPaper, style).replace(/'/g, "\\'")}')">
